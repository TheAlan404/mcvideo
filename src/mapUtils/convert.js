...
async function convertFrame (data) {
  ...
  for (let i = 0; i < data.length; i += 3) {
    ...
    const g = data[i + 1]
    const b = data[i + 2]
    const mapColor = convertColor(r, g, b)
